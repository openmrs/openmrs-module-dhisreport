...
public class WeeklySaturdayPeriod extends Period {

	public static final String ISO_FORMAT = "yyyy'W'ww";

	public WeeklySaturdayPeriod(Date date) {
		startDate = new DateTime(date).withDayOfWeek(DateTimeConstants.SATURDAY).toDate();
