...
public class WeeklyWednesdayPeriod extends Period {

	public static final String ISO_FORMAT = "yyyy'W'ww";

	public WeeklyWednesdayPeriod(Date date) {
		startDate = new DateTime(date).withDayOfWeek(DateTimeConstants.WEDNESDAY).toDate();
