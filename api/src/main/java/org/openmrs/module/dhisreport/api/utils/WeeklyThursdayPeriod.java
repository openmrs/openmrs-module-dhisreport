...
public class WeeklyThursdayPeriod extends Period {

	public static final String ISO_FORMAT = "yyyy'W'ww";

	public WeeklyThursdayPeriod(Date date) {
		startDate = new DateTime(date).withDayOfWeek(DateTimeConstants.THURSDAY).toDate();
