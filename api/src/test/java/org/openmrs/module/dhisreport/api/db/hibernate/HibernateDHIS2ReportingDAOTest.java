    ...
    extends BaseModuleContextSensitiveTest
{
    ...
    @Test
    public void shouldSaveObjectIfPreExists()
    ...
    @Test
    public void shouldSaveDataValueTemplate()
        throws IOException, Exception
    {
        ClassPathResource resource = new ClassPathResource( "reportDefinition.xml" );
        dhis2ReportingService.unMarshallandSaveReportTemplates( resource.getInputStream() );
        ...
        criteria.add( Restrictions.eq( "reportDefinition", rd1 ) ).add( Restrictions.eq( "dataelement", de1 ) ).add(
